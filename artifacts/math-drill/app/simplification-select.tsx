...
const DIFFICULTIES: { key: Difficulty; label: string; desc: string; hint: string; example: string }[] = [
  {
    key: "easy",
    label: "Easy",
    desc: "a + b × c",
...
export default function SimplificationSelectScreen() {
  ...
  const accent = colors.simplification;
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <View style={[styles.iconBox, { backgroundColor: accent + "22" }]}>
            <Feather name="layers" size={28} color={accent} />
          </View>
          <Text style={[styles.screenTitle, { color: colors.foreground }]}>Simplification</Text>
            ...
            return (
              ...
              >
                <View style={[styles.opIcon, { backgroundColor: active ? accent + "22" : colors.muted + "22" }]}>
                  <Feather
                    name={d.key === "easy" ? "smile" : d.key === "medium" ? "target" : "layers"}
                    size={20}
